...
Channel.hasOne(Subscribe, { foreignKey: 'subscribed_channel_id', as: 'Channel_Subscribe' });
Subscribe.belongsTo(Channel, { foreignKey: 'subscribed_channel_id', as: 'Channel_Subscribe' });
